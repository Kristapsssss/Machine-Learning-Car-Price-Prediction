...
numerical_features = ['Year', 'Mileage (km)', 'Engine Size (L)', 'Car Age']
...
# Save the model
joblib.dump(best_rf, 'Models/random_forest_model_no_categories.pkl')

# Save Feature Importance
joblib.dump(feature_importance_df, 'Feature Importance/feature_importance_df_no_categories.pkl')

# Predict using the loaded model
loaded_rf = joblib.load('Models/random_forest_model_no_categories.pkl')
...
model_stats = pd.DataFrame({
    'Model Type': ['Random Forest Without Categories'],
    'Model Name': ['random_forest_model_no_categories.pkl'],
    'MAE': [mae],
    'MSE': [mse],
    'R²': [r2]
})
